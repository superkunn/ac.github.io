...
m_text = str(sum_n) + ',' + str(nyist_n) + ',' + str(sdut_n) + ',' + str(poj_n)
e_text = ']];var data_max = 500; var line_title = ["AC题数"]; var y_label = "AC题数"; var x_label = "oj"; var x = ["总量","nyist","sdut","poj"]; var title = "渣渣的题量";j.jqplot.diagram.base("chart2", data, line_title, "渣渣的题量，自动统计", x, x_label, y_label, data_max, 2);</script></body></html>'
